...

		{
...

			{
				...
				case 9:
				{
					top = list->GetTop();
					cin >> index;
					if (Find_Item_Double_List(top, index)) {
						cout << "Element est`!" << endl;
						system("pause");
					}
					else {
						cout << "Elementa nety!" << endl;
						system("pause");
					}
					//cout <<"Element:" <<Find_Item_Double_List(top, index) << endl;
				}
